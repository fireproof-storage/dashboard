        ...
        <button
          ...
          className={`${
            needsSave
              ? ""
              : "opacity-50"
          } flex items-center justify-center gap-[5px] py-2 h-[38px] rounded-fp-s min-w-[105px] bg-fp-p font-medium text-fp-bg-00 hover:opacity-60`}
        >
          Save
        </button>
      </div>
