  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] min-h-screen overflow-hidden">
      ...
      <div className="flex items-center justify-center h-full">
        <div className={`relative max-w-[445px] p-10 sm:px-[48px] sm:py-[60px] m-10 mb-20 sm:m-14 sm:ml-6 grow-0 rounded-fp-l ${isDarkMode ? "bg-fp-bg-01" : ""}`}>
          <svg width="32" height="36" viewBox="0 0 32 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill="currentColor" className="text-fp-a-02" fillRule="evenodd" clipRule="evenodd" d="M20.7845 9.00879H10.3838L5.2002 18.0004H15.5841L20.7845 9.00879Z" />
            <path fill="currentColor" className="text-fp-a-03" fillRule="evenodd" clipRule="evenodd" d="M10.3838 9.00934H15.4499H20.7845C20.7845 5.16778 18.6876 1.79594 15.5841 0.000976562L10.3838 9.00934Z" />
            <path fill="currentColor" className="text-fp-a-01" fillRule="evenodd" clipRule="evenodd" d="M15.5843 18H5.20036C5.18358 18 5.18358 18 5.18358 18L0 27.0084H10.3839L15.5843 18ZM20.7847 27.0084H31.1686C31.1686 23.1668 29.0884 19.795 25.985 18H25.9682L20.7847 27.0084Z" />
            <path fill="currentColor" className="text-fp-a-00" fillRule="evenodd" clipRule="evenodd" d="M10.3839 27.0088H0L5.20036 36.0004H15.5843C12.4809 34.2054 10.3839 30.8503 10.3839 27.0088ZM31.1686 27.0088H20.7847L15.5843 36.0004H25.9682L31.1686 27.0088Z" />
          </svg>
          <h1 className="text-[6.5vw] font-bold xs:text-34 mb-[30px] sm:mb-[46px] mt-[16px] tracking-[0.02em] leading-[1.3]">Sign in to Fireproof Dashdoard</h1>
          <h2 className="text-11 text-fp-dec-02 mb-4">Email preferences</h2>
          <p className="text-14 sm:text-16 max-w-[90%] mb-4 text-balance"><b>Would you like to receive emails from us?</b></p>
